    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-96">
      ...
      <form action="../includes/signup.inc.php" method="post">
        ...
        <div class="mb-4">
          ...
          <input type="email" id="email" name="email" class="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
        ...
        <div class="mb-6">
          ...
          <input type="password" id="confirmPassword" name="confirmPassword" class="w-full px-4 py-2 mt-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>

        <button type="submit" class="w-full bg-green-500 text-white py-2 rounded-md mt-4 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500">
          Sign Up
        </button>
      </form>
